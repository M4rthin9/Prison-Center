...
<div class="space-y-6">
  ...
  <Alert tone="info" title="ระบบอยู่ในเฟส 0 — รากฐาน">
    ระบบยืนยันตัวตน การจำกัดขอบเขตตามเรือนจำ ตารางตั้งค่า และ audit log พร้อมใช้งานแล้ว ส่วนงานขาย
    การชำระเงิน การฝากเงิน จดหมาย และการเยี่ยม จะเปิดใช้ตามลำดับเฟส
  </Alert>
  ...
  <div class="grid gap-4 lg:grid-cols-2">
    ...
    <Card title="ขอบเขตข้อมูลของคุณ">
      <p class="text-sm text-muted">
        ...
        {:else}
          บัญชีนี้เห็นเฉพาะข้อมูลของ {session.scopeLabel} เท่านั้น การเข้าถึงข้อมูลเรือนจำอื่นจะถูกปฏิเสธที่ระดับ
          API ไม่ใช่ที่หน้าจอ
        {/if}
      </p>
    </Card>
